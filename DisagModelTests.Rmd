...
I use an optimizatio function to tell me what value of flux attenuation that I ask the model for will get me the value I actually wnat
...
And this is still wrong. WTF?

```{r}
shuffle_tune(0.9072, test_df$np, 0.8)
```

Inside of shuffle tune
Browse[2]> abun_out
 [1] 5.401371e+04 3.766620e+04 2.181525e+04 1.244173e+04 7.062806e+03 3.947304e+03 2.273857e+03 1.282719e+03 7.264740e+02 4.034763e+02 2.377060e+02 1.327258e+02 7.284586e+01
[14] 4.133340e+01 2.346461e+01 1.331038e+01 7.394540e+00 4.189514e+00 2.361232e+00 1.317098e+00 7.563452e-01 4.225558e-01 2.320890e-01 1.341889e-01 6.551500e-02

I need to look at this with a clear mind.

Inside of shuffle_tune function

Browse[2]> flux_out/flux_in
[1] 0.8000242
Browse[2]> flux_in
[1] 187215.6
Browse[2]> flux_out
