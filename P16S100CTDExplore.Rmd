...
plotBeamSTOxy <- function(){
  ...
  mtext("Depth (m)", side = 2, line = 2, cex = 1.25)
  par(new = TRUE)
  plot(p16ctdData$oxygen, p16ctdData$pressure, type = "l", ylim = c(1200, 0), col = "slateblue1", lwd = 8, lty = "solid", ylab = "", xlab = "", axes = FALSE)
  axis(side = 3, padj = 1, tcl = .5)
  mtext( "Oxygen (µM)", side = 3, line = 1.25)
  ...
  axis(side = 1, padj = GlobalAdjust, tcl = .5) # at = seq(from = 0.075, to = 0.225, by = 0.025)
