...
DisagAttemptNonPowerLaw -- Early version of disaggregation Model.
...
Explore_Big_And_Small -- Early look into large vs small particles. Size cutoff was I think 53 microns.

scratch.R -- playing around with stuff, who even knows what I was doing (Archive)

Explore_Quantiles_And_Size_Cutoff -- an early look into whether there were ever so few large particles that I could show there were more zeros than we would expect from chance. There weren't.

.Rprofile -- Functions that run every time I launch R no matter what

Explore_Processed_UVP -- My earlist look at the UVP data
