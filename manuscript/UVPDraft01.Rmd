...
# Author list 
(Putative, order not set, Please suggest others. Please add your middle initial if you want to have one. Please add/confirm your ORCID, if you have one.)
...
We measured water properties of temperature, salinity, fluorescence, oxygen concentration and turbidity using the shipboard XXX CTD {ask Al Devol}. Data were processed using Seabird Software and analyzed and visualized in *R*.

## Water mass analysis
Optimum multiparameter analysis was performed to map the percent identify of the water observed at each depth to four water masses: the XXX, YYY, ZZZ, and AAA following Evans et al. [-@evansRoleWaterMasses2020] was calculated from temperature, salinity, oxygen and phosphorous concentrations measured at this site, where phosphorous measurments were measured colorimetrically, and all other measurements are from the CTD. 
