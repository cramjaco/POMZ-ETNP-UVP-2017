...
(Passow and Carlson 2012; Siegel et al.~2016; Francois et al.~2002). The
transfer efficiency of the biological pump may affect global atmospheric
carbon levels \citep{kwonImpactRemineralizationDepth2009} (Kwon,
Primeau, and Sarmiento 2009). Thus, understanding the processes that
shape organic matter degradation in the mesopelagic is critical.
...
\citep{weberEfficientParticleTransfer2020}

Actual refs \citep{evansRoleWaterMasses2020}
...
\begin{figure}[h]
\includegraphics{ETNP-Particles_files/figure-latex/unnamed-chunk-2-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-2}
\end{figure}
...
\includegraphics{ETNP-Particles_files/figure-latex/unnamed-chunk-3-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-3}
\end{sidewaysfigure}
