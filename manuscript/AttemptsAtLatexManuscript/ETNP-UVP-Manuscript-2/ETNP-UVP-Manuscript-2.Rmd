...
## Example one ref
As seen by [@needhamPronouncedDailySuccession2016]

## Example of two refs

Also shown in [@gasolFrameworkAssessmentTopdown1994; @mestreSinkingParticlesPromote2018]

[@gasolFrameworkAssessmentTopdown1994]

then

[@abrahaoAnalysisTranslationrelatedGene2017; @sanudo-wilhelmyRoleVitaminsMarine2014]

With more clicking about [@smithModelingEffectsOyster2009; @williamsMarineMetaproteomicsDeciphering]
