...
cycle
\citep{neuerOceanBiologicalCarbon2014, turnerZooplanktonFecalPellets2015}.
Organic matter flux into the deep ocean is a function both of export
from the photic zone into the mesopelagic (export flux), and the
fraction of that flux that crosses through the mesopelagic (transfer
efficiency)
\citep{francoisFactorsControllingFlux2002, passowBiologicalPumpHigh2012, siegelPredictionExportFate2016}.
The transfer efficiency of the biological pump may affect global
atmospheric carbon levels \citep{kwonImpactRemineralizationDepth2009}.
Thus, understanding the processes that shape organic matter degradation
in the mesopelagic is critical.
...
\subsection{Example one ref}

As seen by \citep{needhamPronouncedDailySuccession2016}

\subsection{Example of two refs}

Also shown in
\citep{gasolFrameworkAssessmentTopdown1994, mestreSinkingParticlesPromote2018}

\citep{gasolFrameworkAssessmentTopdown1994}

then

\citep{abrahaoAnalysisTranslationrelatedGene2017, sanudo-wilhelmyRoleVitaminsMarine2014}

With more clicking about
\citep{smithModelingEffectsOyster2009, williamsMarineMetaproteomicsDeciphering}
...
\begin{figure}[h]
\includegraphics{ETNP-UVP-Manuscript-2_files/figure-latex/unnamed-chunk-2-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-2}
\end{figure}
...
\includegraphics{ETNP-UVP-Manuscript-2_files/figure-latex/unnamed-chunk-3-1} \caption{Please caption every figure}\label{fig:unnamed-chunk-3}
\end{sidewaysfigure}
